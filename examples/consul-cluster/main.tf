...
locals {
  ...
  consul_server_source_image = "consul-server-5f7bc819-ef6e-5239-deda-67567a3496ad"
}
...
locals {
  ...
  consul_client_source_image = "consul-client-5f7b6972-af40-29c9-2574-75d284ef0a00"
}
